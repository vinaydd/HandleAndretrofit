...
import com.singh.vinay.hadlercalleverysecond.server.ApiConstant;
...
public class AppPreference {
    ...
    public AppPreference(Context context) {
        this.appSharedPrefs = context.getSharedPreferences(ApiConstant.APP_SHARED_PREFS, Activity.MODE_PRIVATE);
